            ...
            '<div class="details">' + 
                ...
                '<ul class="actions">' + 
                    '<% if (canResolve) { %>' + 
                        '<li>' +
                            '<% if (isMuted) { %>' +
                                '<a href="#" data-action="unresolve" title="Unmute Updates"><i class="icon-bullhorn"></i></a>' + 
                            '<% } else if (isResolved) { %>' + 
                                '<a href="#" data-action="mute" title="Mute Future Updates"><i class="icon-volume-off"></i></a>' + 
                            '<% } else { %>' + 
                                '<a href="#" data-action="resolve" title="Mark as Resolved"><i class="icon-checkmark"></i></a>' + 
                            '<% } %>' + 
                        '</li>' + 
                        '<li>' + 
