...
import Button, {ButtonLabel} from 'app/components/buttons/button';
import DropdownMenu from 'app/components/dropdownMenu';
import {StyledButtonGroup} from 'app/components/buttonGroup';
...
const StyledDropdownToggle = styled(Button)`
  ${StyledButtonGroup} ${StyledDropdown}:last-child:not(:first-child) & {
