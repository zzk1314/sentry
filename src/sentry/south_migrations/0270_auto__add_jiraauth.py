...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'JiraAuth'
        db.create_table('sentry_jira_auth', (
            ('id', self.gf('sentry.db.models.fields.bounded.BoundedBigAutoField')(primary_key=True)),
            ('client_key', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
            ('shared_secret', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.send_create_signal('sentry', ['JiraAuth'])


    def backwards(self, orm):
        # Deleting model 'JiraAuth'
        db.delete_table('sentry_jira_auth')
    ...
    models = {
        ...
        'sentry.broadcast': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 8, 18, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.jiraauth': {
            'Meta': {'object_name': 'JiraAuth', 'db_table': "'sentry_jira_auth'"},
            'base_url': ('django.db.models.fields.CharField', [], {'max_length': '60'}),
            'client_key': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'public_key': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'shared_secret': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
