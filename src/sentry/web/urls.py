...
from sentry.web.frontend.jira_ui_widget import JiraConfigView, JiraUIWidgetConfigView, \
    JiraUIWidgetView, JiraInstalledCallback
...
urlpatterns += patterns(
    ...
    url(r'^jira-ui-config$', JiraUIWidgetConfigView.as_view()),
