...
class ReleaseActivityEmail(ActivityEmail):
    ...
    def get_participants(self):
        ...
        participants_opted = {
            ...
            for user, option in users_with_options if option == UserOptionValue.all_deploys
        }

        # merge the two type of participants
        return dict(
            chain(six.iteritems(participants_committed), six.iteritems(participants_opted))
        )
