...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AccessGroupOption'
        db.create_table(u'sentry_accessgroupoption', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('access_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sentry.Team'])),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('value', self.gf('picklefield.fields.PickledObjectField')()),
        ))
        db.send_create_signal(u'sentry', ['AccessGroupOption'])

        # Adding unique constraint on 'AccessGroupOption', fields ['access_group', 'key']
        db.create_unique(u'sentry_accessgroupoption', ['access_group_id', 'key'])

        # Adding field 'AccessGroup.last_synced'
        db.add_column(u'sentry_accessgroup', 'last_synced',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'AccessGroupOption', fields ['access_group', 'key']
        db.delete_unique(u'sentry_accessgroupoption', ['access_group_id', 'key'])

        # Deleting model 'AccessGroupOption'
        db.delete_table(u'sentry_accessgroupoption')

        # Deleting field 'AccessGroup.last_synced'
        db.delete_column(u'sentry_accessgroup', 'last_synced')
    ...
    models = {
        ...
        u'sentry.accessgroup': {
            ...
            'last_synced': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True'}),
        ...
        u'sentry.accessgroupoption': {
            'Meta': {'unique_together': "(('access_group', 'key'),)", 'object_name': 'AccessGroupOption'},
            'access_group': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sentry.Team']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
